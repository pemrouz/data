// types/surface.ts — the TYPES-FIRST public surface (plan §3.2; STATUS
...
export const value: unique symbol = Symbol.for('data.v4.value')
export const node: unique symbol = Symbol.for('data.v4.node')
