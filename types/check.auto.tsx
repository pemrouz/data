// types/check.auto.tsx — AUTOMATIC-transform JSX fixtures (jsx
// "react-jsx", jsxImportSource "data"). Compiled by `npx tsc -p
// types/tsconfig.auto.json` (noCheck:false): the transform resolves
// `data/jsx-runtime` through the paths map to ./jsx-runtime-decl.d.ts,
