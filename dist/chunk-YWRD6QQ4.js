import { noop, isArray, iter, view } from './chunk-VOTKTX55.js';
...
var Prop = class extends Child {
  ...
  set set(value) {
    value === false || value === void 0 ? this.remove() : this.add(value);
  }
};
var Attr = class extends Prop {
  add(value) {
    this.parent.setAttribute(this.name, value);
  }
  remove() {
...
var Style = class extends Prop {
  add(value) {
    this.parent.style.setProperty(this.name, value);
  }
  remove() {
...
//# sourceMappingURL=chunk-YWRD6QQ4.js.map
//# sourceMappingURL=chunk-YWRD6QQ4.js.map