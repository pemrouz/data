...
var _devtoolsInternalRoots = globalThis[/* @__PURE__ */ Symbol.for("data.internalRoots")] ??= /* @__PURE__ */ new WeakSet();
...
function* iterRoots(opts) {
  for (const ref of _devtoolsRoots) {
    ...
    if (_devtoolsInternalRoots.has(v)) continue;
    yield v;
  }
}
...
var methodOfCtor = (ctor) => METHOD_OF[ctor] || (ctor || "").replace(/Value$/, "").toLowerCase();
