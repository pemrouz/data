// devtools/panel/inspector.ts — the slide-in inspector: three tabs
...
//
// Import boundary: './ctx.js' (type-only), '../index.js' (consumption layer),
// '../../api/index.js' (type-only here). No kernel/render/compat paths.
...
export function mountInspector(ctx          , host     )                                       {
  const doc = ctx.doc
